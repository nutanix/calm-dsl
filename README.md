...
`Latest release version: 4.4.0, Latest-release-tag: v4.4.0`

`Latest Release Notes:` [read here](https://github.com/nutanix/calm-dsl/tree/master/release-notes/4.4.0)
