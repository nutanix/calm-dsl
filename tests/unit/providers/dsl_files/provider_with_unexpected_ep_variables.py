...
class DslProviderWithVariablesInStandardEPSchema(CloudProvider):
    ...
    endpoint_schema = ProviderEndpointSchema(
        type=PROVIDER.ENDPOINT_KIND.GCP,
        variables=[CalmVariable.Simple.string(name="server_ip", value="")],
    )
