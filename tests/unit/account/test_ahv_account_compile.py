...
class TestAhvAccountCompile:
    ...
    def test_ahv_account_basic_auth(self):
        ...
        with patch('calm.dsl.builtins.models.ahv_account.is_compile_secrets', return_value=True):
    ...
    def test_ahv_account_without_secrets_compilation(self):
        ...
        with patch('calm.dsl.builtins.models.ahv_account.is_compile_secrets', return_value=False):
    ...
    @pytest.mark.skipif(
        LV(Version.get_version("Calm")) < LV(ACCOUNT.SERVICE_ACCOUNT.FEATURE_MIN_VERSION),
