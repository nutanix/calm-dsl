...
from tests.api_interface.test_runbooks.test_files.while_task import WhileTask, WhileTaskLoopVariable
    ...
    def test_while_task_loop_variable(self):
        ...
        for task in task_list:
            ...
            if task["type"] == 'SET_VARIABLE' or task['type'] == 'HTTP':
                ...
                for message in task["message_list"]:
                    validation_errors += message["message"]
                assert "Loop variable has already been used" in validation_errors
