...
class TestDecisionTasks:
    ...
    def test_decision_task(self):
        ...
        IncorrectPaths = ["SUCCESS2", "FAILURE1", "SUCCESS4", "FAILURE3", "SUCCESS6", "FAILURE5"]
        ...
        for entity in entities:
            if entity["status"]["type"] == "task_runlog" and entity["status"]["task_reference"]["name"] in IncorrectPaths:
                pytest.fail("[{}] path should not get executed".format(entity["status"]["task_reference"]["name"]))
