...
ObjectsGeturl = "https://{}:9440/oss/api/nutanix/v3/objectstores/{}/buckets/{}".format(pc_ip, objectstore_uuid,bucket_name)

output = RestAPI(ObjectsGeturl, "GET", None, pc_username, pc_password)
if output.json()["metadata"]["uuid"]:
