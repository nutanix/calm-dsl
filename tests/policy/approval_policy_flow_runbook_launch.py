...
class PolicyAprroval(Policy):
    """This policy gives sample on how any policy can be defined for runbook launch in calm-dsl."""
    ...
    conditions = [
        CalmPolicy.Condition(
            attribute="Runbook Name", operator="contains", value="policy_approval"
        )
    ]
