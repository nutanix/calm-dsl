...
class PolicyAprroval(Policy):
    """This policy gives sample on how any policy can be defined with unicode charecters in calm-dsl."""
    ...
    # condition list
    conditions = [
        CalmPolicy.Condition(attribute="Blueprint Name", operator="contains", value="∞")
    ]
