...
class NewNetworkGroupTunnel2(NetworkGroupTunnel):
    ...
    tunnel_vm_spec = ahv_network_group_tunnel_vm_spec("auto_cluster_prod_4fee9603c584", "ng_tunnel_vpc_subnet_e61ad7fdb778") #ahv_network_group_tunnel_vm_spec is requireding as first argument a Nutanix Cluster name, and as second argument a subnet internal to the VPC
