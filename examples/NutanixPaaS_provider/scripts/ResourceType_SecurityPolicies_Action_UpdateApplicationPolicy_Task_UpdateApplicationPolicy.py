...
def create_payload():
    ...
    payload["name"] = "@@{policy_new_name}@@".strip()
    ...
    # Quarantine only for update forensic type.
    # if 'QUARANTINE' in rule_type:
    #    payload['rules']['type'] = "QUARANTINE"
    #    payload['rules'].append(add_quarantine_rule())
