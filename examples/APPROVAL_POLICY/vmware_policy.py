...
class PolicyAprroval(Policy):
    """This policy gives sample on how any policy can be defined for VMWare provider in calm-dsl."""
    ...
    # condition list
    conditions = [
        CalmPolicy.Condition(attribute="VMWare: Cores Per Socket", operator="<", value="3"),
        CalmPolicy.Condition(attribute="VMWare: Memory", operator=">", value="2")
        ]
