class VCENTER:
    ...
    CONTROLLER = {
        ...
        'SATA': {
            'Virtual SATA Controller': 'VirtualAHCIController'
        }
    }
    ...
    OperatingSystem = {
        "Windows": "GUEST_OS_WINDOWS",
        "LINUX": "GUEST_OS_LINUX"
    }
    ...
    SATAControllerOptions = {
        'VirtualAHCIController': 'Virtual SATA Controller'
    }
